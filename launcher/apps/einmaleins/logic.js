// Practice logic for "Einmaleins": facts, Leitner boxes, session building, answer options,
// and the "move up a help level" suggestion. Pure functions, no DOM.
// Unit tested in tests/einmaleins.test.mjs.
...
export { ORDER, SESSION_SIZE, MAX_BOX_BY_LEVEL, key, factsFor, newStat, statOf, applyAnswer, buildSession, requeue, choices, shuffle, reihenOf, reiheScores, levelUpReihen };
